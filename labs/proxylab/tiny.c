/*************************************************************************
	...
	> Created Time: 2015年05月30日 星期六 23时33分03秒
 ************************************************************************/
...
void doit(int fd){
    ...
    if(stat(filename, &sbuf) < 0) {
        clienterror(fd, filename, "404", "Not found", "Tiny counld not find this file\n");
        return;
    }
    if(is_static){
